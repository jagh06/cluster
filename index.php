...
<body class="d-flex align-items-center py-4 bg-body-tertiary">
  ...
  <main class="form-signin w-100 m-auto">
    <form action="./login/login-student.php" method="POST">
      ...
      <a href="./registro.php" class="link-re">¿Perdiste tu contraseña?</a>
      <br><br>
      <div class="row-registration">
        <p class="text-question">¿No tienes cuenta?</p>
        <a class="link-re" href="./registro.php">Registrate</a>
      </div>
      <br><br>

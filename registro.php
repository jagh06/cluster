...
<body class="d-flex align-items-center py-4 bg-body-tertiary">
    ...
    <main class="form-signin w-100 m-auto">
        <form action="./register/register-student.php" method="POST">
            ...
            <div class="form-floating">
                <input type="password" class="form-control" id="rcontrasenia" name="rcontrasenia" placeholder="Password">
                <label for="floatingPassword">Repite tu contraseña</label>
            </div>

            <div class="row-registration">
                <p class="text-question">¿Ya tienes una cuenta?</p>
                <a class="link-re" href="./index.php">Login</a>
            </div>
            <br><br>
            <button class="btn btn-primary w-100 py-2" type="submit">Registro</button>
            <br><br>
            <p class="mt-5 mb-3 text-body-secondary">&copy; CLUSTER 2024</p>
        </form>
    </main>
